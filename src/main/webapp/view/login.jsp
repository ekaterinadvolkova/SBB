...
<nav class="navbar navbar-expand-sm navbar-dark bg-dark" aria-label="Third navbar example">
    <div class="container-fluid">
        <a class="navbar-brand" href="welcomePage">Swiss Federal Railways</a>
...
<main>
    <div class="container pt-5">
        ...
        <form:form class="style" id="loginForm" modelAttribute="login" action="${contextPath}/loginProcess" method="post">
            <table align="center">
                ...
                <tr>
                    <div class="mb-3">
                        ...
                        <input type="text" value="${user.password}" class="form-control" path="password" id="password"
                               name="password"
                               placeholder="Type here ...">
                    </div>
                </tr>
        ...
        <table align="center">
            ...
            <tr>
                <td><a href="/welcome">Forgotten your Password?</a>
                </td>
            </tr>
        </table>
